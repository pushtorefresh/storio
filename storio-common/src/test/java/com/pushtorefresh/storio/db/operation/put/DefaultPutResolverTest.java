...
public class DefaultPutResolverTest {
    ...
    private static class TestItem {
        ...
        static final MapFunc<TestItem, ContentValues> MAP_TO_CONTENT_VALUES = new MapFunc<TestItem, ContentValues>() {
            ...
            // ContentValues should be mocked for usage (damn you Android...)
    ...
    public void insert() {
        ...
        final PutResult putResult = putResolver.performPut(storIODb, TestItem.MAP_TO_CONTENT_VALUES.map(testItem));
    ...
    public void update() {
        ...
        final PutResult putResult = putResolver.performPut(storIODb, expectedContentValues);
