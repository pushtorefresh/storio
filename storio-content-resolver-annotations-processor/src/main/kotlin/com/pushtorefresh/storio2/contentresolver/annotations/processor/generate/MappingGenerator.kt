...
import com.pushtorefresh.storio2.common.annotations.processor.generate.Common
...
object MappingGenerator : Generator<StorIOContentResolverTypeMeta> {
    ...
    override fun generateJavaFile(typeMeta: StorIOContentResolverTypeMeta): JavaFile {
        ...
        val superclass = ClassName.get("com.pushtorefresh.storio2.contentresolver", SUFFIX)
