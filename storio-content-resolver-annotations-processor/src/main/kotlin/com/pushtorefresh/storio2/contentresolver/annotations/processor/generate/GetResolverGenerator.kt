...
import com.pushtorefresh.storio2.common.annotations.processor.generate.Common.getFromCursorString
...
object GetResolverGenerator : Generator<StorIOContentResolverTypeMeta> {
    ...
    override fun generateJavaFile(typeMeta: StorIOContentResolverTypeMeta): JavaFile {
        ...
        val getResolver = TypeSpec.classBuilder(generateName(typeMeta))
                ...
                .addModifiers(PUBLIC)
                .superclass(ParameterizedTypeName.get(ClassName.get("com.pushtorefresh.storio2.contentresolver.operations.get", "DefaultGetResolver"), className))
                .addMethod(
