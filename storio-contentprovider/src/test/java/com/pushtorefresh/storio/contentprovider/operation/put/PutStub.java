...
class PutStub {
    ...
    void verifyBehavior(@NonNull PutCollectionResult<TestItem> putCollectionResult) {
    ...
    void verifyBehavior(@NonNull PutResult putResult) {
        ...
        verifyBehavior(PutCollectionResult.newInstance(putResultMap));
    }
}
