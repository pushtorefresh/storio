...
public class PreparedDeleteCollectionOfObjects<T> extends PreparedDelete<DeleteResults<T>, Collection<T>> {
    ...
    /**
     * Creates {@link io.reactivex.Flowable} which will perform Delete Operation and send result to observer.
     * <p>
     * Returned {@link io.reactivex.Flowable} will be "Cold Flowable", which means that it performs
     ...
     * </dl>
     *
     * @return non-null {@link io.reactivex.Flowable} which will perform Delete Operation.
