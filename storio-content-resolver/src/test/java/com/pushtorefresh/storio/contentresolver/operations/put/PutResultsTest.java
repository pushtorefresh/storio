...
public class PutResultsTest {
    ...
    public void numberOfInsertsShouldBeZero() {
        ...
        putResultMap.put("key", PutResult.newUpdateResult(1, Uri.parse("content://affectedUri")));
    ...
    public void checkToStringImplementation() {
        checkToString(PutResults.newInstance(new HashMap<Object, PutResult>() {
            {
                put("key1", PutResult.newInsertResult(Uri.parse("content://insertedUri"), Uri.parse("content://affectedUri")));
                put("key2", PutResult.newUpdateResult(10, Uri.parse("content://affectedUri")));
            }
        }));
    }
}
