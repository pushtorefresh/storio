...
public class QueryGeneratorTest {
    ...
    public void createWhereOneKeyColumn() {
        ...
        storIOSQLiteTypeMeta.columns.put("column2", new StorIOSQLiteColumnMeta(null, null, "testField1", null, storIOSQLiteColumn2, false));

        final StorIOSQLiteColumn storIOSQLiteColumn3 = mock(StorIOSQLiteColumn.class);
        when(storIOSQLiteColumn3.key()).thenReturn(false);
        storIOSQLiteTypeMeta.columns.put("column3", new StorIOSQLiteColumnMeta(null, null, null, null, storIOSQLiteColumn3, false));
    ...
    public void createWhereMultipleKeyColumns() {
        ...
        storIOSQLiteTypeMeta.columns.put("column1", new StorIOSQLiteColumnMeta(null, null, "testField1", null, storIOSQLiteColumn1, false));
        ...
        storIOSQLiteTypeMeta.columns.put("column3", new StorIOSQLiteColumnMeta(null, null, "testField3", null, storIOSQLiteColumn3, false));
