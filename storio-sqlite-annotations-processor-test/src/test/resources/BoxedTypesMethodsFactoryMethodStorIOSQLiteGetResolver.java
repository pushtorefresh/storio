 ...
 */
public class BoxedTypesMethodsFactoryMethodStorIOSQLiteGetResolver extends DefaultGetResolver<BoxedTypesMethodsFactoryMethod> {
    /**
     * {@inheritDoc}
     */
    @Override
    ...
    public BoxedTypesMethodsFactoryMethod mapFromCursor(@NonNull Cursor cursor) {
        ...
        BoxedTypesMethodsFactoryMethod object = BoxedTypesMethodsFactoryMethod.create(booleanField, shortField, intField, longField, floatField, doubleField);
