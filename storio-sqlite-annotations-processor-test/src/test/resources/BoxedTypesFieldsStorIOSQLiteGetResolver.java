 ...
 */
public class BoxedTypesFieldsStorIOSQLiteGetResolver extends DefaultGetResolver<BoxedTypesFields> {
    /**
     * {@inheritDoc}
     */
    @Override
    @NonNull
    public BoxedTypesFields mapFromCursor(@NonNull StorIOSQLite storIOSQLite, @NonNull Cursor cursor) {
