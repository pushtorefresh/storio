...
public class StorIOSQLiteAnnotationsProcessorTest {
  ...
  public void shouldNotCompileIfNestedClassAnnotatedWithTypeAnnotation() {
    ...
    assert_().about(javaSource())
        ...
        .failsToCompile()
        .withErrorContaining("StorIOSQLiteType can't be applied to nested or inner classes:"
            + " ActualClass");
  }
  ...
  public void shouldNotCompileIfNotClassAnnotatedWithTypeAnnotations() {
    ...
    assert_().about(javaSource())
        ...
        .processedWith(new StorIOSQLiteProcessor())
        .failsToCompile()
        .withErrorContaining("StorIOSQLiteType can be applied only to classes not to"
            + " AnnotatedInterface");
  }
  ...
  public void shouldNotCompileIfAnnotatedFieldNotInsideClass() {
    ...
    assert_().about(javaSource())
        ...
        .processedWith(new StorIOSQLiteProcessor())
        .failsToCompile()
        .withErrorContaining("Please apply StorIOSQLiteColumn only to members of class"
            + " (fields or methods) - not to members of AnnotatedFieldNotInsideClass");
  }
  ...
  public void shouldNotCompileIfAnnotatedFieldInsideNotAnnotatedClass() {
    ...
    assert_().about(javaSource())
        ...
        .processedWith(new StorIOSQLiteProcessor())
        .failsToCompile()
        .withErrorContaining("Please annotate class AnnotatedFieldInsideNotAnnotatedClass"
            + " with StorIOSQLiteType");
  }
  ...
  public void shouldNotCompileIfAnnotatedFieldIsPrivate() {
    ...
    assert_().about(javaSource())
        ...
        .processedWith(new StorIOSQLiteProcessor())
        .failsToCompile()
        .withErrorContaining("StorIOSQLiteColumn can not be applied to private field or"
            + " method: id");
  }
  ...
  public void shouldNotCompileIfAnnotatedMethodHasParameters() {
    ...
    assert_().about(javaSource())
        ...
        .processedWith(new StorIOSQLiteProcessor())
        .failsToCompile()
        .withErrorContaining("StorIOSQLiteColumn can not be applied to method with"
            + " parameters: id");
  }
  ...
  public void shouldNotCompileIfCreatorNotInsideClass() {
    ...
    assert_().about(javaSource())
        ...
        .processedWith(new StorIOSQLiteProcessor())
        .failsToCompile()
        .withErrorContaining("Please apply StorIOSQLiteCreator to constructor or"
            + " factory method of class - not to CreatorNotInsideClass");
  }
  ...
  public void shouldNotCompileIfCreatorInsideNotAnnotatedClass() {
    ...
    assert_().about(javaSource())
        ...
        .processedWith(new StorIOSQLiteProcessor())
        .failsToCompile()
        .withErrorContaining("Please annotate class CreatorInsideNotAnnotatedClass with"
            + " StorIOSQLiteType");
  }
  ...
  public void shouldNotCompileIfCreatorIsPrivate() {
    ...
    assert_().about(javaSource())
        ...
        .processedWith(new StorIOSQLiteProcessor())
        .failsToCompile()
        .withErrorContaining("StorIOSQLiteCreator can not be applied to private methods "
            + "or constructors: <init>");
  }
  ...
  public void shouldNotCompileIfCreatorMethodIsNotStatic() {
    ...
    assert_().about(javaSource())
        ...
        .processedWith(new StorIOSQLiteProcessor())
        .failsToCompile()
        .withErrorContaining("StorIOSQLiteCreator can not be applied to non-static methods:"
            + " creator");
  }
  ...
  public void shouldNotCompileIfCreatorMethodReturnsDifferentType() {
    JavaFileObject model = JavaFileObjects.forResource(
        "CreatorMethodWithDifferentReturnType.java");

    assert_().about(javaSource())
        .that(model)
        .processedWith(new StorIOSQLiteProcessor())
        .failsToCompile()
        .withErrorContaining("StorIOSQLiteCreator can not be applied to method with"
            + " return type different from CreatorMethodWithDifferentReturnType");
  }
  ...
  public void shouldNotCompileIfTableIsEmpty() {
    ...
    assert_().about(javaSource())
        ...
        .processedWith(new StorIOSQLiteProcessor())
        .failsToCompile()
        .withErrorContaining("Table name of EmptyTable annotated with StorIOSQLiteType"
            + " is empty");
  }
  ...
  public void shouldNotCompileIfClassContainsBothAnnotatedFieldsAndMethods() {
    ...
    assert_().about(javaSource())
        ...
        .processedWith(new StorIOSQLiteProcessor())
        .failsToCompile()
        .withErrorContaining("Can't apply StorIOSQLiteColumn annotation to both fields"
            + " and methods in a same class: MixedFieldsAndMethods");
  }
  ...
  public void shouldNotCompileIfTypeIsUnsupported() {
    ...
    assert_().about(javaSource())
        ...
        .processedWith(new StorIOSQLiteProcessor())
        .failsToCompile()
        .withErrorContaining("Unsupported type of field or method for StorIOSQLiteColumn"
  ...
  public void shouldNotCompileIfClassContainsMultipleCreators() {
    ...
    assert_().about(javaSource())
        ...
        .processedWith(new StorIOSQLiteProcessor())
        .failsToCompile()
        .withErrorContaining("Only one creator method or constructor is allowed:"
            + " MultipleCreators");
  }
  ...
  public void shouldNotCompileIfClassIsEmpty() {
    ...
    assert_().about(javaSource())
        ...
        .processedWith(new StorIOSQLiteProcessor())
        .failsToCompile()
        .withErrorContaining("Class marked with StorIOSQLiteType annotation should have"
            + " at least one field or method marked with StorIOSQLiteColumn annotation:"
            + " EmptyClass");
  }
  ...
  public void shouldNotCompileIfClassDoesNotHaveKey() {
    ...
    assert_().about(javaSource())
        ...
        .failsToCompile()
        .withErrorContaining("Class marked with StorIOSQLiteType annotation should have"
            + " at least one KEY field or method marked with StorIOSQLiteColumn annotation:"
            + " NoKey");
  }
  ...
  public void shouldNotCompileIfClassNeedsCreatorAndDoesNotHaveOne() {
    ...
    assert_().about(javaSource())
        ...
        .processedWith(new StorIOSQLiteProcessor())
        .failsToCompile()
        .withErrorContaining("Class marked with StorIOSQLiteType annotation needs"
            + " factory method or constructor marked with StorIOSQLiteCreator annotation:"
            + " NoCreator");
  }
  ...
  public void shouldNotCompileIfNoArgConstructorIsAbsent() {
    ...
    assert_().about(javaSource())
        ...
        .withErrorContaining("constructor AbsenceOfNoArgConstructor in class " +
            "com.pushtorefresh.storio.sqlite.annotations.AbsenceOfNoArgConstructor"
  ...
  public void shouldCompileWithPrimitiveFields() {
    ...
    JavaFileObject generatedTypeMapping = JavaFileObjects
        .forResource("PrimitiveFieldsSQLiteTypeMapping.java");
    JavaFileObject generatedDeleteResolver = JavaFileObjects
        .forResource("PrimitiveFieldsStorIOSQLiteDeleteResolver.java");
    JavaFileObject generatedGetResolver = JavaFileObjects
        .forResource("PrimitiveFieldsStorIOSQLiteGetResolver.java");
    JavaFileObject generatedPutResolver = JavaFileObjects
        .forResource("PrimitiveFieldsStorIOSQLitePutResolver.java");
  ...
  public void shouldCompileWithBoxedTypesFields() {
    ...
    JavaFileObject generatedTypeMapping = JavaFileObjects
        .forResource("BoxedTypesFieldsSQLiteTypeMapping.java");
    JavaFileObject generatedDeleteResolver = JavaFileObjects
        .forResource("BoxedTypesFieldsStorIOSQLiteDeleteResolver.java");
    JavaFileObject generatedGetResolver = JavaFileObjects
        .forResource("BoxedTypesFieldsStorIOSQLiteGetResolver.java");
    JavaFileObject generatedPutResolver = JavaFileObjects
        .forResource("BoxedTypesFieldsStorIOSQLitePutResolver.java");
  ...
  public void shouldCompileWithBoxedTypesFieldsMarkedAsIgnoreNull() {
    ...
    JavaFileObject generatedTypeMapping = JavaFileObjects
        .forResource("BoxedTypesFieldsIgnoreNullSQLiteTypeMapping.java");
    JavaFileObject generatedDeleteResolver = JavaFileObjects
        .forResource("BoxedTypesFieldsIgnoreNullStorIOSQLiteDeleteResolver.java");
    JavaFileObject generatedGetResolver = JavaFileObjects
        .forResource("BoxedTypesFieldsIgnoreNullStorIOSQLiteGetResolver.java");
    JavaFileObject generatedPutResolver = JavaFileObjects
        .forResource("BoxedTypesFieldsIgnoreNullStorIOSQLitePutResolver.java");
  ...
  public void shouldCompileWithMethodsReturningPrimitivesAndConstructorAsCreator() {
    ...
    JavaFileObject generatedTypeMapping = JavaFileObjects
        .forResource("PrimitiveMethodsConstructorSQLiteTypeMapping.java");
    JavaFileObject generatedDeleteResolver = JavaFileObjects
        .forResource("PrimitiveMethodsConstructorStorIOSQLiteDeleteResolver.java");
    JavaFileObject generatedGetResolver = JavaFileObjects
        .forResource("PrimitiveMethodsConstructorStorIOSQLiteGetResolver.java");
    JavaFileObject generatedPutResolver = JavaFileObjects
        .forResource("PrimitiveMethodsConstructorStorIOSQLitePutResolver.java");
  ...
  public void shouldCompileWithMethodsReturningBoxedTypesAndConstructorAsCreator() {
    ...
    JavaFileObject generatedTypeMapping = JavaFileObjects
        .forResource("BoxedTypesMethodsConstructorSQLiteTypeMapping.java");
    JavaFileObject generatedDeleteResolver = JavaFileObjects
        .forResource("BoxedTypesMethodsConstructorStorIOSQLiteDeleteResolver.java");
    JavaFileObject generatedGetResolver = JavaFileObjects
        .forResource("BoxedTypesMethodsConstructorStorIOSQLiteGetResolver.java");
    JavaFileObject generatedPutResolver = JavaFileObjects
        .forResource("BoxedTypesMethodsConstructorStorIOSQLitePutResolver.java");
  ...
  shouldCompileWithMethodsReturningBoxedTypesAndMarkedAsIgnoreNullAndConstructorAsCreator() {
    JavaFileObject model = JavaFileObjects
        .forResource("BoxedTypesMethodsConstructorIgnoreNull.java");

    JavaFileObject generatedTypeMapping = JavaFileObjects
        .forResource("BoxedTypesMethodsConstructorIgnoreNullSQLiteTypeMapping.java");
    JavaFileObject generatedDeleteResolver = JavaFileObjects
        .forResource("BoxedTypesMethodsConstructorIgnoreNullStorIOSQLiteDeleteResolver.java");
    JavaFileObject generatedGetResolver = JavaFileObjects
        .forResource("BoxedTypesMethodsConstructorIgnoreNullStorIOSQLiteGetResolver.java");
    JavaFileObject generatedPutResolver = JavaFileObjects
        .forResource("BoxedTypesMethodsConstructorIgnoreNullStorIOSQLitePutResolver.java");
  ...
  public void shouldCompileWithMethodsReturningPrimitivesAndFactoryMethodAsCreator() {
    ...
    JavaFileObject generatedTypeMapping = JavaFileObjects
        .forResource("PrimitiveMethodsFactoryMethodSQLiteTypeMapping.java");
    JavaFileObject generatedDeleteResolver = JavaFileObjects
        .forResource("PrimitiveMethodsFactoryMethodStorIOSQLiteDeleteResolver.java");
    JavaFileObject generatedGetResolver = JavaFileObjects
        .forResource("PrimitiveMethodsFactoryMethodStorIOSQLiteGetResolver.java");
    JavaFileObject generatedPutResolver = JavaFileObjects
        .forResource("PrimitiveMethodsFactoryMethodStorIOSQLitePutResolver.java");
  ...
  public void shouldCompileWithMethodsReturningBoxedTypesAndFactoryMethodAsCreator() {
    ...
    JavaFileObject generatedTypeMapping = JavaFileObjects
        .forResource("BoxedTypesMethodsFactoryMethodSQLiteTypeMapping.java");
    JavaFileObject generatedDeleteResolver = JavaFileObjects
        .forResource("BoxedTypesMethodsFactoryMethodStorIOSQLiteDeleteResolver.java");
    JavaFileObject generatedGetResolver = JavaFileObjects
        .forResource("BoxedTypesMethodsFactoryMethodStorIOSQLiteGetResolver.java");
    JavaFileObject generatedPutResolver = JavaFileObjects
        .forResource("BoxedTypesMethodsFactoryMethodStorIOSQLitePutResolver.java");
  ...
  shouldCompileWithMethodsReturningBoxedTypesAndMarkedAsIgnoreNullAndFactoryMethodAsCreator() {
    JavaFileObject model = JavaFileObjects
        .forResource("BoxedTypesMethodsFactoryMethodIgnoreNull.java");

    JavaFileObject generatedTypeMapping = JavaFileObjects
        .forResource("BoxedTypesMethodsFactoryMethodIgnoreNullSQLiteTypeMapping.java");
    JavaFileObject generatedDeleteResolver = JavaFileObjects
        .forResource("BoxedTypesMethodsFactoryMethodIgnoreNullStorIOSQLiteDeleteResolver.java");
    JavaFileObject generatedGetResolver = JavaFileObjects
        .forResource("BoxedTypesMethodsFactoryMethodIgnoreNullStorIOSQLiteGetResolver.java");
    JavaFileObject generatedPutResolver = JavaFileObjects
        .forResource("BoxedTypesMethodsFactoryMethodIgnoreNullStorIOSQLitePutResolver.java");
