package com.pushtorefresh.storio3.sqlite.annotations.processor.test;

import com.google.testing.compile.JavaFileObjects;
import com.pushtorefresh.storio3.sqlite.annotations.processor.StorIOSQLiteProcessor;
...
public class StorIOSQLiteAnnotationsProcessorTest {
    ...
    public void shouldNotCompileIfNoArgConstructorIsAbsent() {
        ...
        assert_().about(javaSource())
                ...
                .processedWith(new StorIOSQLiteProcessor())
                .failsToCompile()
                .withErrorContaining("constructor AbsenceOfNoArgConstructor in class com.pushtorefresh.storio3.sqlite.annotations.AbsenceOfNoArgConstructor"
    ...
    public void shouldNotGenerateTableClassIfDisabled() {
        ...
        assert_().about(javaSource())
                ...
                .compilesWithoutError()
                .and()
                .generatesFileNamed(SOURCE_OUTPUT, "com.pushtorefresh.storio3.sqlite.annotations", "WithoutGeneratedTableTable.java");
    }
}
