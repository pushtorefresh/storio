 ...
 */
public class BoxedTypesMethodsFactoryMethodIgnoreNullStorIOContentResolverPutResolver extends DefaultPutResolver<BoxedTypesMethodsFactoryMethodIgnoreNull> {
    /**
     * {@inheritDoc}
     */
    @Override
    @NonNull
    public InsertQuery mapToInsertQuery(@NonNull BoxedTypesMethodsFactoryMethodIgnoreNull object) {
    ...
    @Override
    @NonNull
    public UpdateQuery mapToUpdateQuery(@NonNull BoxedTypesMethodsFactoryMethodIgnoreNull object) {
