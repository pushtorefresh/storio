...
public class BoxedTypesPrivateFieldsStorIOContentResolverGetResolver extends DefaultGetResolver<BoxedTypesPrivateFields> {
    ...
    @Override
    @NonNull
    public BoxedTypesPrivateFields mapFromCursor(@NonNull StorIOContentResolver storIOContentResolver, @NonNull Cursor cursor) {
        ...
        BoxedTypesPrivateFields object = new BoxedTypesPrivateFields(field1, field2, field3, field4, field5, field6);
