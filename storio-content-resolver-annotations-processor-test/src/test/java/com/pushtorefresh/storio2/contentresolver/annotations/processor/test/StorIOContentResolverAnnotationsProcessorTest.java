package com.pushtorefresh.storio2.contentresolver.annotations.processor.test;

import com.google.testing.compile.JavaFileObjects;
import com.pushtorefresh.storio2.contentresolver.annotations.processor.StorIOContentResolverProcessor;
    ...
    public void shouldNotCompileIfNoArgConstructorIsAbsent() {
        ...
        assert_().about(javaSource())
                ...
                .withErrorContaining("constructor AbsenceOfNoArgConstructor in class " +
                        "com.pushtorefresh.storio2.contentresolver.annotations.AbsenceOfNoArgConstructor cannot be applied to given types;\n" +
                        "  required: long\n" +
                        "  found: no arguments\n" +
